...
function StHeader({ onCTA }) {
  return (
    <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--navy-900)' }}>
      <div style={{ position: 'absolute', inset: 0, backgroundImage: "url('assets/startups/header-bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.42, pointerEvents: 'none' }} />
