...
function TvHeader({ onCTA }) {
  return (
    <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--navy-900)' }}>
      <div style={{ position: 'absolute', inset: 0, backgroundImage: "url('assets/travel/header-bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.46, pointerEvents: 'none' }} role="img" aria-label="Sunset over a tropical beach representing travel and hospitality software" />
