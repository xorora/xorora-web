...
function EmCases() {
  const cases = [
    { href: 'Regula Case Study.html', img: 'assets/regula/featured.jpg', tag: 'Fixed Scope', title: 'Regulatory Intelligence Platform', stat: '70%', statLabel: 'Less workload' },
    { href: 'Unified AI Voice Operations Case Study.html', img: 'assets/saas/voice-ops.jpg', tag: 'Variable Scope', title: 'AI Voice Operations Platform', stat: '4', statLabel: 'Portals shipped' },
    { href: 'PingPanda Case Study.html', img: 'assets/saas/event-monitoring.jpg', tag: 'Staff Augmentation', title: 'SaaS Event Monitoring', stat: '13mo', statLabel: 'To production' },
  ];
  return (
