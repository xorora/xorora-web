...
function HwReasons() {
  ...
  return (
    <LightSection bg="var(--slate-50)">
      <div style={{ display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 'clamp(32px,5vw,72px)', alignItems: 'start' }} className="hw-2col">
        <h2 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: 'clamp(30px,4vw,46px)', lineHeight: 1.08, letterSpacing: '-0.02em', color: 'var(--fg1)', margin: 0, position: 'sticky', top: 110, textWrap: 'balance' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 22 }} className="hw-reasons-grid">
