...
function Header({ onCTA }) {
  return (
    <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--navy-900)' }}>
      ...
      <div style={{ position: 'relative', maxWidth: 1240, margin: '0 auto', padding: 'clamp(60px,7vw,96px) 32px clamp(68px,8vw,108px)', display: 'grid', gridTemplateColumns: '1.04fr 0.96fr', gap: 'clamp(40px,5vw,72px)', alignItems: 'center' }} className="cs-header-grid">
        <div>
        ...
        <div style={{ position: 'relative' }} className="cs-header-art">
          <BrowserFrame src={window.__resources.mockBusiness} alt="Business portal dashboard" url="app.xorora.ai/dashboard" glow />
