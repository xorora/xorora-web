  ...
  return (
    <LightSection bg="var(--surface)">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(20px,3vw,28px)', alignItems: 'center', marginBottom: 40 }} className="cs-overview-grid">
        <BrowserFrame src={window.__resources.mockMembers} alt="Regula organization members" url="app.regula.io/members" />
        <BrowserFrame src={window.__resources.mockBilling} alt="Regula billing and usage" url="app.regula.io/billing" />
      </div>
