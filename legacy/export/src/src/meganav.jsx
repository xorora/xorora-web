      ...
      <div style={{ display: 'flex', justifyContent: 'center', padding: '18px 20px 0' }}>
        <div style={{
          ...
          <a href="Homepage V2.html" style={{ position: 'relative', display: 'flex', alignItems: 'center', height: 36, width: scrolled ? 40 : 150, transition: 'width .35s cubic-bezier(.4,0,.2,1)', flexShrink: 0 }}>
            <img src={window.__resources.navLogoFull} alt="Xorora" style={{ position: 'absolute', left: 0, height: 28, opacity: scrolled ? 0 : 1, transition: 'opacity .3s ease' }} />
            <img src={window.__resources.navLogoX} alt="Xorora" style={{ position: 'absolute', left: 0, height: 28, opacity: scrolled ? 1 : 0, transition: 'opacity .3s ease' }} />
          </a>
