...
function EngResults() {
  const cases = [
    { href: 'Regula Case Study.html', img: window.__resources.caseRegula, tag: 'RegTech', title: 'Regulatory Intelligence Platform', stat: '70%', sl: 'Less workload' },
    { href: 'Unified AI Voice Operations Case Study.html', img: window.__resources.caseVoice, tag: 'AI Voice', title: 'AI Voice Operations Platform', stat: '4', sl: 'Portals shipped' },
    { href: 'PingPanda Case Study.html', img: window.__resources.caseEvent, tag: 'SaaS', title: 'SaaS Event Monitoring', stat: '13mo', sl: 'To production' },
  ];
  return (
