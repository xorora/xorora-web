...
function Footer({ onNav }) {
  ...
  const cols = [
    { h: 'Engineering', items: ['AI Software Development', 'Custom App Development', 'Application Modernization', 'MVP / POC Development', 'CMS Development Services', 'UI/UX Services'] },
    { h: 'Data & AI', items: ['Data Analytics', 'Data Engineering', 'Cloud Engineering & Migration', 'AI Agent Development', 'ML & Data Science Services', 'Workflow Automation Services'] },
    { h: 'Marketing Services', items: ['SEO', 'Local SEO', 'Google Ads', 'Meta Ads', 'Social Media Management', 'B2B Marketing'] },
    ...
    { h: 'Consulting', items: ['Discovery Workshop', 'AI Consulting', 'Digital Transformation'] },
    { h: 'Managed Services', items: ['DevOps', 'Cybersecurity', 'IT Infrastructure'] },
    { h: 'Engagement Model', items: ['Fixed Scope', 'Variable Scope', 'Staff Augmentation'] },
    { h: 'Company', items: ['About Us', 'Blogs', 'How we Work', 'Awards & Recognition', { label: 'Our Work', href: 'Our Work.html' }, { label: 'Contact us', action: 'contact' }] },
  ];
  const offices = [
