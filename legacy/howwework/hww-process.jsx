...
const HW_FLOWS = {
  staff: [
    { n: '01', img: 'assets/howwework/staff-1.jpg', title: 'Evaluation', accent: 'of an existing product', body: 'We discuss your idea, vision, and business targets. That sets scope and requirements. In staff augmentation, we adjust to your existing team.',
    ...
    { n: '02', img: 'assets/howwework/staff-2.jpg', title: 'Onboarding', accent: 'and integration', body: 'Your new engineers integrate into your workflow, tools, and rituals. They ramp on the codebase fast and start contributing within the first sprint.',
    ...
    { n: '03', img: 'assets/howwework/staff-3.jpg', title: 'Delivery', accent: 'inside your process', body: 'Our engineers work as part of your team, in your sprints, under your direction. You keep full control of priorities while we add senior capacity.',
    ...
    { n: '04', img: 'assets/howwework/staff-4.jpg', title: 'Scale', accent: 'up or down', body: 'As your needs change, we flex the team. Add specialists for a push or scale back between phases, with no long recruitment cycles.',
  ...
  dedicated: [
    { n: '01', img: 'assets/howwework/discovery.jpg', title: 'Evaluation', accent: 'and discovery', body: 'We discuss your idea, vision, and business targets you want to achieve. This helps us set a clear scope, requirements, and a costed roadmap.',
    ...
    { n: '02', img: 'assets/howwework/team.jpg', title: 'Team assembly', accent: 'and project kick-off', body: 'We assemble a team based on your requirements. You interview and pick the talents you want on your dedicated development team.',
    ...
    { n: '03', img: 'assets/howwework/dev.jpg', title: 'Development', accent: 'phase', body: 'We follow Agile and Lean principles, dividing work into two-week sprints that each deliver usable parts of the system across web and mobile.',
    ...
    { n: '04', img: 'assets/howwework/launch.jpg', title: 'Software', accent: 'project launch', body: 'After launching the MVP we continue development, maintenance, and support, making room for additional features after customer feedback.',
