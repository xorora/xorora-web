...
function HwCases() {
  const cases = [
    { href: 'Regula Case Study.html', img: 'assets/regula/featured.jpg', tag: 'RegTech', title: 'Regulatory Intelligence Platform', stat: '70%', statLabel: 'Less workload' },
    { href: 'Unified AI Voice Operations Case Study.html', img: 'assets/saas/voice-ops.jpg', tag: 'AI Voice', title: 'AI Voice Operations Platform', stat: '4', statLabel: 'Portals shipped' },
    { href: 'PingPanda Case Study.html', img: 'assets/saas/event-monitoring.jpg', tag: 'SaaS', title: 'SaaS Event Monitoring', stat: '13mo', statLabel: 'To production' },
  ];
  return (
