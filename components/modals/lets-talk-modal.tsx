  ...
  return (
    <div className="lt-fade pointer-events-auto fixed inset-0 z-200 flex items-center justify-center bg-[rgba(2,6,15,0.6)] p-[clamp(16px,4vw,48px)] backdrop-blur-[6px]">
      ...
      <div
        ...
        className="lt-pop relative z-10 max-h-[92vh] w-full max-w-[1180px] overflow-y-auto rounded-r-xl border border-white/10 bg-navy-900 shadow-[0_40px_120px_-40px_rgba(0,0,0,0.8)]"
      >
        <div
...
function LtField({
  ...
  const className = cn(
    "box-border w-full resize-none rounded-r-md border bg-white/4 px-3.5 py-3 font-sans text-[15px] text-white outline-hidden",
