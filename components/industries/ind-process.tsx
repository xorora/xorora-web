    ...
    <DarkSection bloom="50% 4%">
      ...
      <div className="ind-proc-grid grid grid-cols-4 gap-5">
        {STEPS.map((step) => (
          <div
            key={step.n}
            className="ind-reveal relative overflow-hidden rounded-r-lg border border-white/12 bg-white/4 p-[clamp(24px,2.4vw,30px)]"
          >
            <div className="absolute inset-x-0 top-0 h-[3px] bg-linear-to-r from-indigo-400 to-indigo-700" />
            <div className="mb-[18px] flex items-center justify-between">
              <span className="flex h-[46px] w-[46px] items-center justify-center rounded-r-md border border-indigo-300/32 bg-indigo-700/28 text-indigo-300">
