...
export function ClearbeamDemoBanner() {
  return (
    <section
      style={{
        position: "relative",
    ...
    >
      ...
      >
        ...
        >
          We will walk you through the full setup — from your first API call to
          your first email alert. No slides. No sales pitch. Just the product.
        </p>
        <div
          style={{
            display: "flex",
