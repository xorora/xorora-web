...
function MindsetCard({
  ...
  return (
    <div
      className={cn(
        "group relative overflow-hidden rounded-r-lg border border-border bg-surface p-[clamp(26px,2.8vw,36px)] shadow-xs",
    ...
    >
      ...
      <span className="mb-5 flex h-12 w-12 items-center justify-center rounded-r-md bg-indigo-50 text-xo-indigo transition-colors duration-200 group-hover:bg-xo-indigo group-hover:text-white">
