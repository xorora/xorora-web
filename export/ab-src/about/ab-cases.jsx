...
function AbCases({ onTalk }) {
  const cases = [
    { href: 'Regula Case Study.html', img: window.__resources.caseRegula, client: 'REGULA', clientIcon: 'landmark', tag: 'RegTech & Compliance', title: 'Real-time regulatory intelligence for emerging markets', stat: '70%', statLabel: 'Less compliance workload' },
    { href: 'Unified AI Voice Operations Case Study.html', img: window.__resources.caseVoice, client: 'AI VOICE OPS', clientIcon: 'audio-lines', tag: 'AI Voice & B2B SaaS', title: 'From fragmented tools to unified AI voice operations', stat: '4', statLabel: 'Portals on one backend' },
  ];
  return (
