...
function V2Cases({ onTalk }) {
  const cases = [
    { href: 'Unified AI Voice Operations Case Study.html', img: window.__resources.caseVoice, tag: 'AI Voice & B2B SaaS', title: 'From fragmented tools to unified AI voice operations', stat: '4', statLabel: 'Portals on one backend' },
    { href: 'Regula Case Study.html', img: window.__resources.caseRegula, tag: 'RegTech & Compliance', title: 'Real-time compliance intelligence for emerging markets', stat: '70%', statLabel: 'Less compliance workload' },
    { href: 'PingPanda Case Study.html', img: window.__resources.casePing, tag: 'SaaS & Real-time', title: 'Real-time SaaS event monitoring with instant visibility', stat: 'Real-time', statLabel: 'Event delivery' },
  ];
  return (
