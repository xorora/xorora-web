...
function IndCaseStudies() {
  const cases = [
    { href: 'Regula Case Study.html', img: window.__resources.caseRegula, tags: ['RegTech', 'FinTech'], title: 'Regulatory Intelligence Platform', desc: 'An automation first platform that monitors regulators continuously and alerts compliance teams in under an hour.', stats: [['70%', 'Less workload'], ['< 1 hr', 'Detection']] },
    { href: 'Unified AI Voice Operations Case Study.html', img: window.__resources.caseVoice, tags: ['AI Voice', 'B2B SaaS'], title: 'AI Voice Operations Platform', desc: 'Four purpose built portals on one shared backend turned voice agent technology into a commercially ready product.', stats: [['4', 'Portals'], ['16 mo', 'To production']] },
    { href: 'PingPanda Case Study.html', img: window.__resources.caseEvent, tags: ['SaaS', 'Real-time'], title: 'SaaS Event Monitoring', desc: 'An API first event notifier: send a typed event, get an instant alert with full context. No blind spots.', stats: [['Real-time', 'Delivery'], ['13 mo', 'To production']] },
  ];
  return (
